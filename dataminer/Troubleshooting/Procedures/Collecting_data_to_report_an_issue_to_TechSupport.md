...
The Log Collector package will be saved by default in an *SL_LogCollector* folder on your desktop. Please do not rename, modify or compress (zip) any of the files.
